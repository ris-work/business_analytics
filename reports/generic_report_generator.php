...
<div class="center">
      ...
      <fieldset><legend>
      <h1 class="title">Report Generator</h1></legend>
     
  <form action="generic_movements.php" method="get">
  ...
  <input list="generic" name="generic" id="generics">

...
.print "</pre><div style='text-align: center; font-family: \"Cousine\", \"IBM Courier\"; color: black; white-space: pre;' class='table-container'><table>"
...
SELECT sih_current.itemcode AS code, sih, desc, sell, 

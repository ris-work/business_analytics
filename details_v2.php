...
<table class="named">
<tr>
<td colspan=2 style="color: #008500; width: 20em;">This page loads cached data. You pressed the (O) or v2 link. You might want to go back to go to an up-to-date version. REALTIME date is <a href="details.php?id=<?php echo $_GET["id"] ?>">HERE</a>.</td>
</tr>
<tr>
<th>Name</th>

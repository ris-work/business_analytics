...
<div id ="bottom"> <button onclick="goback()" class="btn goback" > <img  src="icons/back_button.png" style="height:42%; width:42%;"> </button>
<button class="btn goback"> <img  src="icons/graph.png" style="height: 62%; width:62%"> </button><div>
</body>
</html>

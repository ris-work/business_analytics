...
<link rel="icon" type="image/svg+xml" href="icons/warehouse.svg">
		<link rel="apple-touch-icon" size="180x180" type="image/png" href="icons/warehouse_180.png" />
		<link rel="apple-touch-icon" size="120x120" type="image/png" href="icons/warehouse_120.png" />
		<link rel="apple-touch-icon" size="152x152" type="image/png" href="icons/warehouse_152.png" />
		<link rel="apple-touch-icon" size="any" type="image/svg+xml" href="icons/warehouse.svg" />
<script>
dump="";
var json_p="";
